...
#include "ProjectPathfinderOffroadCar.h"
#include "ProjectPathfinderOffroadWheelFront.h"
#include "ProjectPathfinderOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AProjectPathfinderOffroadCar::AProjectPathfinderOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UProjectPathfinderOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UProjectPathfinderOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UProjectPathfinderOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UProjectPathfinderOffroadWheelRear::StaticClass();
