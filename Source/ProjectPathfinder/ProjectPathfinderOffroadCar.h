...
#include "ProjectPathfinderOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class PROJECTPATHFINDER_API AProjectPathfinderOffroadCar : public AProjectPathfinderPawn
{
	GENERATED_BODY()
