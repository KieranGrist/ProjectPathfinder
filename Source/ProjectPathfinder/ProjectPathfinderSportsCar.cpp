...
#include "ProjectPathfinderSportsCar.h"
#include "ProjectPathfinderSportsWheelFront.h"
#include "ProjectPathfinderSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AProjectPathfinderSportsCar::AProjectPathfinderSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UProjectPathfinderSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UProjectPathfinderSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UProjectPathfinderSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UProjectPathfinderSportsWheelRear::StaticClass();
